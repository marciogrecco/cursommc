...
import com.modelagemsistemasjava.enun.Perfil;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException, java.text.ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "marciogreco131@gmail.com", 
				"36378912377", TipoCliente.PESSOAFISICA,
				pe.encode("123456"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "marcio.greco@outlook.com", "31628382740", TipoCliente.PESSOAFISICA, pe.encode("123"));
